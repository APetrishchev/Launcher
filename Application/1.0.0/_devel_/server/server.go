...
var staticPath = "/home/apetrishchev/Portable/Projects/github.com/APetrishchev/Laucher/"
...
func (self *HttpServer) StartHTTPS() {
	...
	if len(Config.TlsCertFileName) > 0 {
		cert, err := tls.LoadX509KeyPair(filepath.Join(Config.CertDirPath, Config.TlsCertFileName),
			filepath.Join(Config.CertDirPath, Config.TlsKeyFileName))
		if err != nil {
