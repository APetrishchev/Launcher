...
// console.log("addEventListeners", eventName, element, eventListener, options)
  ...
  static append(element, children) {
    if (children === undefined) {
      return }
    else if (typeof children === "string" || typeof children === "number" || children instanceof HTMLElement) {
  ...
  show() {
    if (!this.isDisplayed) {
      ...
      classList: this.classList, placeholder: this.placeholder, disabled: this.disabled, tips: this.tips,
