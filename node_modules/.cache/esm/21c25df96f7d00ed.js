  ...
  show(parent) {
    ...
    for (let row = 1; row < 7; row++) {
      for (let col = 1; col < 8; col++) {
        ...
        if (this.onClick) {
          div.addEventListener("click", (evn) => this.onClick(pos))
        }
        pos++
      }
    }
